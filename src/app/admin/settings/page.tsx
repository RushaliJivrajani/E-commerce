      ...
      <form onSubmit={handleSave} className="space-y-6 text-sm">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-xl border border-white/10 bg-card/5 py-2.5 px-3 focus:outline-none focus:border-indigo-400 text-white transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="+91..."
                className="mt-1 block w-full rounded-xl border border-white/10 bg-card/5 py-2.5 px-3 focus:outline-none focus:border-indigo-400 text-white transition-colors font-mono"
              />
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="₹"
                className="mt-1 block w-full rounded-xl border border-white/10 bg-card/5 py-2.5 px-3 focus:outline-none focus:border-indigo-400 text-indigo-400 transition-colors font-bold"
              />
            </div>
            ...
            <div className="sm:col-span-3 mt-2">
              <label className="flex items-center gap-3 p-4 rounded-xl border border-rose-500/20 bg-rose-500/10 cursor-pointer">
                <input
                  ...
                  className="h-5 w-5 rounded border-rose-500/50 text-rose-500 focus:ring-rose-500/50 bg-card/5"
                />
                <div>
        ...
        <div className="rounded-2xl border border-white/10 glass-panel p-6 shadow-sm space-y-4">
          ...
          <div className="rounded-xl border border-white/10 bg-card/5 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-lg border border-white/10 bg-card/5 py-2 px-2.5 focus:outline-none focus:border-indigo-400 text-white transition-colors"
                />
              </div>
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-lg bg-indigo-400 px-3.5 py-1.5 text-xs font-bold text-foreground shadow hover:bg-indigo-300 transition-colors"
            >
        ...
        <div className="rounded-2xl border border-white/10 glass-panel p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 rounded-xl border border-primary/20 bg-primary/10 p-3 text-xs text-indigo-400/80 flex gap-2">
        ...
        <div className="flex justify-end pt-4">
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 rounded-xl bg-indigo-400 px-6 py-3 text-xs font-bold text-foreground shadow-[0_0_15px_rgba(251,191,36,0.3)] hover:bg-indigo-300 transition-colors disabled:opacity-50"
          >
