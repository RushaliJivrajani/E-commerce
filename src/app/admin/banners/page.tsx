            ...
            <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
              ...
              <div className="flex items-center justify-between border-t border-border/30 dark:border-slate-800 pt-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button onClick={() => handleDelete(ban.id)} className="p-1.5 rounded-lg text-muted-foreground/80 hover:text-primary hover:bg-primary/10"><Trash2 className="h-4 w-4" /></button>
                </div>
              </div>
            </div>
